...
def plot_performance(file_path, title):
    try:
...
if __name__ == "__main__":
    plot_performance("performance_granular.csv", "Granular Performance Test")
    plot_performance("performance_very_large.csv", "Very Large Performance Test")